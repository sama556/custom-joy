...
function addCustomizedToCart() {
    ...
    // Build glassmorphism content for customized order
    const container = document.createElement('div');
    container.style.display = 'flex';
    container.style.flexDirection = 'column';
    container.style.alignItems = 'stretch';
    ...
    const msg = document.createElement('div');
    msg.textContent = 'Please login to add your customized cake to cart.';
    msg.style.opacity = '0.9';
    msg.style.fontSize = '14px';

    const orderDetails = document.createElement('div');
    orderDetails.style.background = 'rgba(126, 215, 255, 0.1)';
    orderDetails.style.padding = '12px';
    orderDetails.style.borderRadius = '10px';
    orderDetails.style.fontSize = '13px';
    orderDetails.style.marginTop = '8px';

    const details = `
        <div style="font-weight: 600; margin-bottom: 8px;">Your Customization:</div>
        <div>Size: ${size.charAt(0).toUpperCase() + size.slice(1)}</div>
        <div>Flavor: ${flavor.charAt(0).toUpperCase() + flavor.slice(1)}</div>
        <div>Decoration: ${decoration.charAt(0).toUpperCase() + decoration.slice(1)}</div>
        <div style="font-weight: 600; margin-top: 8px;">Total: ${totalPrice}</div>
    `;
